       ...
       href="http://c.fa.jd.com/adclick?sid=2&cid=601&aid=3624&bid=0&unit=35989&advid=105087&guv=&url=http://sale.jd.com/act/PzKvRu4Ld5YnG1Ej.html">
        ...
        <div class="m plist">
            ...
            <div class="sm sm2 fore1 curr" data-widget="tab-item"
                 clstag="homepage|keycount|home2013|18d" id="t1">
                <div class="smt">
                    <h3 id="t1_name"></h3>
                </div>
            ...
            <div class="sm sm2 fore2" data-widget="tab-item"  clstag="homepage|keycount|home2013|18d" id="t2">
                <div class="smt">
                    <h3 id="t2_name"></h3>
                </div>
                <div class="smc" data-widget="tab-content">
            ...
            <div class="sm sm2 fore3" data-widget="tab-item"  clstag="homepage|keycount|home2013|18e" id="t3">
                <div class="smt">
                    <h3 id="t3_name"></h3>
                </div>
                <div class="smc" data-widget="tab-content">
            ...
            <div class="sm sm2 fore4" data-widget="tab-item"  clstag="homepage|keycount|home2013|18f" id="t4">
                <div class="smt">
                    <h3 id="t4_name"></h3>
                </div>
                <div class="smc" data-widget="tab-content">
            ...
            <div class="sm sm2 fore5" data-widget="tab-item" clstag="homepage|keycount|home2013|18g" id="t5">
                <div class="smt">
                    <h3 id="t5_name"></h3>
                </div>
                <div class="smc" data-widget="tab-content">
...
<script type="text/javascript" language="JavaScript">
    $.ajax({
        type:"post",
        url:"/tb_item_descController/item_descShow.do",
        dataType:"json",
        success:function (data) {
            toshowdiv(data.showdiv)
            toshow(data);
        },error:function () {
            alert("hehe")
        }
    ...
    function toshow(data) {
        console.log(data)
        pageConfig.DATA_Tabs = data.showdesc;
    }
    function toshowdiv(data) {
...
//        $("#itemTab").html("");
        for (i in data) {
            ...
            switch (c){
                case 1:
                    document.getElementById("t1").setAttribute("data-tag",i)
                    document.getElementById("t1_name").innerHTML = data[i]
                    break;
                case 2:
                    document.getElementById("t2").setAttribute("data-tag",i)
                    document.getElementById("t2_name").innerHTML = data[i]
                    break;
                case 3:
                    document.getElementById("t3").setAttribute("data-tag",i)
                    document.getElementById("t3_name").innerHTML = data[i]
                    break;
                case 4:
                    document.getElementById("t4").setAttribute("data-tag",i)
                    document.getElementById("t4_name").innerHTML = data[i]
                    break;
                case 5:
                    document.getElementById("t5").setAttribute("data-tag",i)
                    document.getElementById("t5_name").innerHTML = data[i]
                    break;
            }
            c++;
        }
