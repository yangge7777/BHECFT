...
public class ContentServiceImpl implements ContentService {
    ...
    @Override
    public List<Tb_content> getContentList() {
        Tb_contentExample example = new Tb_contentExample();
        Tb_contentExample.Criteria criteria=example.createCriteria();
        List<Tb_content> tb_contents = tb_contentMapper.selectByExampleWithBLOBs(example);
        return tb_contents;
    }
